...
function References() {
  return (
    <div className="references-section-static">
      ...
      <div className="references-header-static">
        <h2 className="references-title-static">
      ...
      <div className="references-content-static">
        <div className="references-grid">
          ...
          <div className="reference-card">
            ...
            <div className="reference-item">
              ...
              <p className="reference-description">
                Human-annotated examples used to calibrate the AI scoring system
            ...
            <div className="methodology-box">
              ...
              <ol>
                ...
                <li>
                  <strong>Procedure Validation:</strong> Medical procedures are
                  verified against ICD-10-PCS standard terminology
                </li>
                <li>
                  <strong>Scoring Calibration:</strong> Few-shot examples ensure
                  consistent scoring across different prompt types
                </li>
              </ol>
            </div>
          </div>
          ...
          <div className="reference-card limitations-card">
            ...
            <div className="limitation-section">
              ...
              <ul>
                ...
                <li>International standard medical procedures (ICD-10-PCS)</li>
          ...
          <div className="reference-card update-card">
            ...
            <p>
              <strong>Update Frequency:</strong> Reference databases are updated
              based on the official organisation updates.
            </p>
